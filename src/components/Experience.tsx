...
const experienceData: ExperienceItem[] = [
    {
        id: 1,
        company: "CloudPivit Technologies",
        role: "Senior Software Engineer",
        duration: "October 2024 - Present",
        logo: logo1,
        accomplishments: [
            "Integrated RAG solutions using Azure Cognitive Search and OpenAI to enhance knowledge retrieval and business automation.",
            "Model hyper-parameter tuning for creativity and improved tokenization for cost reduction.",
            "Engineered a POC to build conversational agentic systems to automate business tasks utilizing google-adk, A2A and Human-in-the-loop architecture.",
            "Improved model evaluation strategies by implementing cross validation and multi-class accuracy matrices.",
            "Utilized hugging face vector embedding models to effectively store large documents into Cosmos DB.",
